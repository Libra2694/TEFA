        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#createDosenModal">Tambah Dosen</button>
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $dosen->prodi }}</td>
                      <td>
                        <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#viewDosenModal-{{ $dosen->id }}">Lihat</button>
                        <button class="btn btn-sm btn-warning" data-toggle="modal" data-target="#editDosenModal-{{ $dosen->id }}">Edit</button>
...
<!-- View Dosen Modal -->
@foreach($dosens as $dosen)
  <div class="modal fade" id="viewDosenModal-{{ $dosen->id }}" tabindex="-1" role="dialog" aria-labelledby="viewDosenModalLabel-{{ $dosen->id }}" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
...
<!-- Edit Dosen Modal -->
@foreach($dosens as $dosen)
  <div class="modal fade" id="editDosenModal-{{ $dosen->id }}" tabindex="-1" role="dialog" aria-labelledby="editDosenModalLabel-{{ $dosen->id }}" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
