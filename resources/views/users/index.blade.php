        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#createUserModal">Tambah Pengguna</button>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#viewUserModal-{{ $user->id }}">Lihat</button>
