...
Route::post('/register/user', [\App\Http\Controllers\Auth\RegisterUserController::class, 'register'])->name('register.user');

// Route untuk registrasi admin
Route::post('/register/admin', [\App\Http\Controllers\Auth\RegisterAdminController::class, 'register'])->name('register.admin');
...
// Route untuk menampilkan halaman pilihan jenis registrasi
Route::get('/register', function () {
    return view('auth.register');
})->name('register');

// Route untuk registrasi user biasa (staff)
Route::get('/register/user', function () {
    return view('auth.registrasi_user');
})->name('register.user');

// Route untuk registrasi admin
Route::get('/register/admin', function () {
    return view('auth.registrasi_admin');
})->name('register.admin');
